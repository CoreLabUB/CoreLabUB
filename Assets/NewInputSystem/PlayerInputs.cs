...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/NewInputSystem/PlayerInputs.inputactions".
/// </summary>
/// <remarks>
...
public partial class @PlayerInputs: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerInputs()
    {
        UnityEngine.Debug.Assert(!m_XRIHead.enabled, "This will cause a leak and performance issues, PlayerInputs.XRIHead.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRIUI.enabled, "This will cause a leak and performance issues, PlayerInputs.XRIUI.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRIRightHandInteraction.enabled, "This will cause a leak and performance issues, PlayerInputs.XRIRightHandInteraction.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRIRightHand.enabled, "This will cause a leak and performance issues, PlayerInputs.XRIRightHand.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRILeftHandInteraction.enabled, "This will cause a leak and performance issues, PlayerInputs.XRILeftHandInteraction.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRILeftHand.enabled, "This will cause a leak and performance issues, PlayerInputs.XRILeftHand.Disable() has not been called.");
    }
    ...
    public struct XRIRightHandActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "XRIRightHand/ThumbStickClicked".
        /// </summary>
    ...
    public interface IXRIRightHandActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "ThumbStickClicked" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
